...
@Configuration
@ComponentScan
public class SimpleSpringContextLuancherApp {

	public static void main(String[] args) {
		
		try(var context =new  AnnotationConfigApplicationContext(SimpleSpringContextLuancherApp.class)){
